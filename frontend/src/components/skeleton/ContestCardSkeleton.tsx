        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-800">
            ...
            <div className="bg-white dark:bg-gray-900 p-5 space-y-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="h-4 w-4 bg-gray-200 dark:bg-gray-700 rounded-full flex-shrink-0" />
                    <div className="flex-1 flex flex-col gap-2">
                        <Skeleton width={60} height={12} baseColor={baseColor} highlightColor={highlightColor} />
                        <Skeleton width="50%" height={16} baseColor={baseColor} highlightColor={highlightColor} />
                    </div>
                </div>
